function varargout = step(S, t)
% STEP  Step response of fractional-order dynamic systems.
%
% The step response of multi-input systems is the collection of step 
% responses for each input channel.
%
% See also: fotf/step
